...
export const createDraftRow = (type, full) => {
  ...
  let plainContent = type === "display" ? createPlainContentSnippet(parsed.plainContent) : parsed.plainContent;
      ...
      <div class="draft-row">
          <div class="draft-row-content">
              <div class="draft-row-header">
                  ...
                  <div class="draft-row-attch">${parsed.attachments.length > 0 ? attachmentIcon : ""}</div>
