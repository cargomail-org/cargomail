...
/**
 * @generated from protobuf message fedemail.BatchDeleteMessagesRequest
 */
...
/**
 * @generated from protobuf message fedemail.BatchModifyMessagesRequest
 */
...
/**
 * @generated from protobuf message fedemail.Draft
 */
export interface Draft {
    ...
    id: string;
    /**
     * @generated from protobuf field: fedemail.Message message = 2;
     */
    message?: Message;
}
/**
 * @generated from protobuf message fedemail.Label
 */
export interface Label {
    ...
    name: string;
    /**
     * @generated from protobuf field: fedemail.Label.Type type = 3;
     */
    type: Label_Type;
}
/**
 * @generated from protobuf enum fedemail.Label.Type
 */
...
/**
 * @generated from protobuf message fedemail.ListDraftsResponse
 */
export interface ListDraftsResponse {
    /**
     * @generated from protobuf field: repeated fedemail.Draft drafts = 1;
     */
    drafts: Draft[];
}
/**
 * @generated from protobuf message fedemail.ListLabelsResponse
 */
export interface ListLabelsResponse {
    /**
     * @generated from protobuf field: repeated fedemail.Label labels = 1;
     */
    labels: Label[];
}
/**
 * @generated from protobuf message fedemail.ListMessagesResponse
 */
export interface ListMessagesResponse {
    /**
     * @generated from protobuf field: repeated fedemail.Message messages = 1;
     */
    messages: Message[];
}
/**
 * @generated from protobuf message fedemail.ListThreadsResponse
 */
export interface ListThreadsResponse {
    /**
     * @generated from protobuf field: repeated fedemail.Thread threads = 1;
     */
    threads: Thread[];
}
/**
 * @generated from protobuf message fedemail.Message
 */
export interface Message {
    ...
    labelIds: string[];
    /**
     * @generated from protobuf field: fedemail.MessagePart payload = 5;
     */
    payload?: MessagePart;
    /**
...
/**
 * @generated from protobuf message fedemail.MessagePart
 */
export interface MessagePart {
    /**
     * @generated from protobuf field: fedemail.MessagePartBody body = 1;
     */
    ...
    filename: string;
    /**
     * @generated from protobuf field: repeated fedemail.MessagePartHeader headers = 3;
     */
    ...
    partId: string;
    /**
     * @generated from protobuf field: repeated fedemail.MessagePart parts = 6;
     */
    parts: MessagePart[];
}
/**
 * @generated from protobuf message fedemail.MessagePartBody
 */
...
/**
 * @generated from protobuf message fedemail.MessagePartHeader
 */
...
/**
 * @generated from protobuf message fedemail.ModifyMessageRequest
 */
...
/**
 * @generated from protobuf message fedemail.ModifyThreadRequest
 */
...
/**
 * @generated from protobuf message fedemail.Thread
 */
export interface Thread {
    ...
    id: string;
    /**
     * @generated from protobuf field: repeated fedemail.Message messages = 3;
     */
    messages: Message[];
    /**
...
/**
 * @generated from protobuf message fedemail.DraftsListRequest
 */
...
/**
 * @generated from protobuf message fedemail.DraftsCreateRequest
 */
export interface DraftsCreateRequest {
    /**
     * @generated from protobuf field: fedemail.Draft message_raw = 1;
     */
    messageRaw?: Draft;
}
/**
 * @generated from protobuf message fedemail.DraftsSendRequest
 */
...
/**
 * @generated from protobuf message fedemail.DraftsGetRequest
 */
...
/**
 * @generated from protobuf message fedemail.DraftsUpdateRequest
 */
export interface DraftsUpdateRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: fedemail.Draft message_raw = 2;
     */
    messageRaw?: Draft;
}
/**
 * @generated from protobuf message fedemail.DraftsDeleteRequest
 */
...
/**
 * @generated from protobuf message fedemail.LabelsCreateRequest
 */
export interface LabelsCreateRequest {
    /**
     * @generated from protobuf field: fedemail.Label label = 1;
     */
    label?: Label;
}
/**
 * @generated from protobuf message fedemail.LabelsGetRequest
 */
...
/**
 * @generated from protobuf message fedemail.LabelsUpdateRequest
 */
export interface LabelsUpdateRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: fedemail.Label label = 2;
     */
    label?: Label;
}
/**
 * @generated from protobuf message fedemail.LabelsDeleteRequest
 */
...
/**
 * @generated from protobuf message fedemail.LabelsPatchRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesListRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesBatchDeleteRequest
 */
export interface MessagesBatchDeleteRequest {
    /**
     * @generated from protobuf field: fedemail.BatchDeleteMessagesRequest batch_delete_messages_request = 1;
     */
    batchDeleteMessagesRequest?: BatchDeleteMessagesRequest;
}
/**
 * @generated from protobuf message fedemail.MessagesBatchModifyRequest
 */
export interface MessagesBatchModifyRequest {
    /**
     * @generated from protobuf field: fedemail.BatchModifyMessagesRequest batch_modify_messages_request = 1;
     */
    batchModifyMessagesRequest?: BatchModifyMessagesRequest;
}
/**
 * @generated from protobuf message fedemail.MessagesSendRequest
 */
export interface MessagesSendRequest {
    /**
     * @generated from protobuf field: fedemail.Message message_raw = 1;
     */
    messageRaw?: Message;
}
/**
 * @generated from protobuf message fedemail.MessagesGetRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesDeleteRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesModifyRequest
 */
export interface MessagesModifyRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: fedemail.ModifyMessageRequest modify_message_request = 2;
     */
    modifyMessageRequest?: ModifyMessageRequest;
}
/**
 * @generated from protobuf message fedemail.MessagesTrashRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesUntrashRequest
 */
...
/**
 * @generated from protobuf message fedemail.MessagesAttachmentsGetRequest
 */
...
/**
 * @generated from protobuf message fedemail.ThreadsListRequest
 */
...
/**
 * @generated from protobuf message fedemail.ThreadsGetRequest
 */
...
/**
 * @generated from protobuf message fedemail.ThreadsDeleteRequest
 */
...
/**
 * @generated from protobuf message fedemail.ThreadsModifyRequest
 */
export interface ThreadsModifyRequest {
    ...
    id: string;
    /**
     * @generated from protobuf field: fedemail.ModifyThreadRequest modify_thread_request = 2;
     */
    modifyThreadRequest?: ModifyThreadRequest;
}
/**
 * @generated from protobuf message fedemail.ThreadsTrashRequest
 */
...
/**
 * @generated from protobuf message fedemail.ThreadsUntrashRequest
 */
...
class BatchDeleteMessagesRequest$Type extends MessageType<BatchDeleteMessagesRequest> {
    constructor() {
        super("fedemail.BatchDeleteMessagesRequest", [
...
/**
 * @generated MessageType for protobuf message fedemail.BatchDeleteMessagesRequest
 */
...
class BatchModifyMessagesRequest$Type extends MessageType<BatchModifyMessagesRequest> {
    constructor() {
        super("fedemail.BatchModifyMessagesRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    ...
                    break;
                case /* fedemail.Message message */ 2:
...
/**
 * @generated MessageType for protobuf message fedemail.Draft
 */
export const Draft = new Draft$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Label$Type extends MessageType<Label> {
    constructor() {
        super("fedemail.Label", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "type", kind: "enum", T: () => ["fedemail.Label.Type", Label_Type] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string name */ 2:
                    ...
                    break;
                case /* fedemail.Label.Type type */ 3:
...
class ListDraftsResponse$Type extends MessageType<ListDraftsResponse> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListDraftsResponse): ListDraftsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated fedemail.Draft drafts */ 1:
    ...
    internalBinaryWrite(message: ListDraftsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated fedemail.Draft drafts = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.ListDraftsResponse
 */
...
class ListLabelsResponse$Type extends MessageType<ListLabelsResponse> {
    constructor() {
        super("fedemail.ListLabelsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListLabelsResponse): ListLabelsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated fedemail.Label labels */ 1:
    ...
    internalBinaryWrite(message: ListLabelsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated fedemail.Label labels = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.ListLabelsResponse
 */
...
class ListMessagesResponse$Type extends MessageType<ListMessagesResponse> {
    constructor() {
        super("fedemail.ListMessagesResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListMessagesResponse): ListMessagesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated fedemail.Message messages */ 1:
    ...
    internalBinaryWrite(message: ListMessagesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated fedemail.Message messages = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.ListMessagesResponse
 */
...
class ListThreadsResponse$Type extends MessageType<ListThreadsResponse> {
    constructor() {
        super("fedemail.ListThreadsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListThreadsResponse): ListThreadsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated fedemail.Thread threads */ 1:
    ...
    internalBinaryWrite(message: ListThreadsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated fedemail.Thread threads = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.ListThreadsResponse
 */
export const ListThreadsResponse = new ListThreadsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Message$Type extends MessageType<Message> {
    constructor() {
        super("fedemail.Message", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated string label_ids */ 4:
                    ...
                    break;
                case /* fedemail.MessagePart payload */ 5:
    ...
    internalBinaryWrite(message: Message, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* fedemail.MessagePart payload = 5; */
        if (message.payload)
...
/**
 * @generated MessageType for protobuf message fedemail.Message
 */
export const Message = new Message$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MessagePart$Type extends MessageType<MessagePart> {
    constructor() {
        super("fedemail.MessagePart", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string part_id */ 5:
                    ...
                    break;
                case /* repeated fedemail.MessagePart parts */ 6:
    ...
    internalBinaryWrite(message: MessagePart, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* fedemail.MessagePartBody body = 1; */
        if (message.body)
        ...
        /* repeated fedemail.MessagePartHeader headers = 3; */
        ...
        /* repeated fedemail.MessagePart parts = 6; */
...
/**
 * @generated MessageType for protobuf message fedemail.MessagePartHeader
 */
...
class ModifyMessageRequest$Type extends MessageType<ModifyMessageRequest> {
    constructor() {
        super("fedemail.ModifyMessageRequest", [
            { no: 1, name: "add_label_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message fedemail.ModifyMessageRequest
 */
...
class ModifyThreadRequest$Type extends MessageType<ModifyThreadRequest> {
    constructor() {
        super("fedemail.ModifyThreadRequest", [
            { no: 1, name: "add_label_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "remove_label_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
class Thread$Type extends MessageType<Thread> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string id */ 2:
                    message.id = reader.string();
                    break;
                case /* repeated fedemail.Message messages */ 3:
                    message.messages.push(Message.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: Thread, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.id);
        /* repeated fedemail.Message messages = 3; */
        for (let i = 0; i < message.messages.length; i++)
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsListRequest
 */
...
class DraftsCreateRequest$Type extends MessageType<DraftsCreateRequest> {
    constructor() {
        super("fedemail.DraftsCreateRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: DraftsCreateRequest): DraftsCreateRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* fedemail.Draft message_raw */ 1:
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsCreateRequest
 */
...
class DraftsSendRequest$Type extends MessageType<DraftsSendRequest> {
    constructor() {
        super("fedemail.DraftsSendRequest", [
            { no: 1, name: "message_raw", kind: "message", T: () => Draft }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsSendRequest
 */
...
class DraftsGetRequest$Type extends MessageType<DraftsGetRequest> {
    constructor() {
        super("fedemail.DraftsGetRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsGetRequest
 */
...
class DraftsUpdateRequest$Type extends MessageType<DraftsUpdateRequest> {
    constructor() {
        super("fedemail.DraftsUpdateRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    message.id = reader.string();
                    break;
                case /* fedemail.Draft message_raw */ 2:
                    message.messageRaw = Draft.internalBinaryRead(reader, reader.uint32(), options, message.messageRaw);
                    break;
                default:
                    let u = options.readUnknownField;
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsUpdateRequest
 */
...
class DraftsDeleteRequest$Type extends MessageType<DraftsDeleteRequest> {
    constructor() {
        super("fedemail.DraftsDeleteRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.DraftsDeleteRequest
 */
...
class LabelsCreateRequest$Type extends MessageType<LabelsCreateRequest> {
    constructor() {
        super("fedemail.LabelsCreateRequest", [
...
/**
 * @generated MessageType for protobuf message fedemail.LabelsCreateRequest
 */
...
class LabelsGetRequest$Type extends MessageType<LabelsGetRequest> {
    constructor() {
        super("fedemail.LabelsGetRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.LabelsGetRequest
 */
...
class LabelsUpdateRequest$Type extends MessageType<LabelsUpdateRequest> {
    constructor() {
        super("fedemail.LabelsUpdateRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message fedemail.LabelsUpdateRequest
 */
...
class LabelsDeleteRequest$Type extends MessageType<LabelsDeleteRequest> {
    constructor() {
        super("fedemail.LabelsDeleteRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.LabelsDeleteRequest
 */
...
class LabelsPatchRequest$Type extends MessageType<LabelsPatchRequest> {
    constructor() {
        super("fedemail.LabelsPatchRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "label", kind: "message", T: () => Label }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.LabelsPatchRequest
 */
...
class MessagesListRequest$Type extends MessageType<MessagesListRequest> {
    constructor() {
        super("fedemail.MessagesListRequest", [
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesListRequest
 */
...
class MessagesBatchDeleteRequest$Type extends MessageType<MessagesBatchDeleteRequest> {
    constructor() {
        super("fedemail.MessagesBatchDeleteRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MessagesBatchDeleteRequest): MessagesBatchDeleteRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* fedemail.BatchDeleteMessagesRequest batch_delete_messages_request */ 1:
    ...
    internalBinaryWrite(message: MessagesBatchDeleteRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* fedemail.BatchDeleteMessagesRequest batch_delete_messages_request = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesBatchDeleteRequest
 */
...
class MessagesBatchModifyRequest$Type extends MessageType<MessagesBatchModifyRequest> {
    constructor() {
        super("fedemail.MessagesBatchModifyRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MessagesBatchModifyRequest): MessagesBatchModifyRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* fedemail.BatchModifyMessagesRequest batch_modify_messages_request */ 1:
    ...
    internalBinaryWrite(message: MessagesBatchModifyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* fedemail.BatchModifyMessagesRequest batch_modify_messages_request = 1; */
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesBatchModifyRequest
 */
...
class MessagesSendRequest$Type extends MessageType<MessagesSendRequest> {
    constructor() {
        super("fedemail.MessagesSendRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MessagesSendRequest): MessagesSendRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* fedemail.Message message_raw */ 1:
    ...
    internalBinaryWrite(message: MessagesSendRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* fedemail.Message message_raw = 1; */
        if (message.messageRaw)
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesSendRequest
 */
...
class MessagesGetRequest$Type extends MessageType<MessagesGetRequest> {
    constructor() {
        super("fedemail.MessagesGetRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesGetRequest
 */
...
class MessagesDeleteRequest$Type extends MessageType<MessagesDeleteRequest> {
    constructor() {
        super("fedemail.MessagesDeleteRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesDeleteRequest
 */
...
class MessagesModifyRequest$Type extends MessageType<MessagesModifyRequest> {
    constructor() {
        super("fedemail.MessagesModifyRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    message.id = reader.string();
                    break;
                case /* fedemail.ModifyMessageRequest modify_message_request */ 2:
    ...
    internalBinaryWrite(message: MessagesModifyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* fedemail.ModifyMessageRequest modify_message_request = 2; */
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesModifyRequest
 */
...
class MessagesTrashRequest$Type extends MessageType<MessagesTrashRequest> {
    constructor() {
        super("fedemail.MessagesTrashRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesTrashRequest
 */
...
class MessagesUntrashRequest$Type extends MessageType<MessagesUntrashRequest> {
    constructor() {
        super("fedemail.MessagesUntrashRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesUntrashRequest
 */
...
class MessagesAttachmentsGetRequest$Type extends MessageType<MessagesAttachmentsGetRequest> {
    constructor() {
        super("fedemail.MessagesAttachmentsGetRequest", [
...
/**
 * @generated MessageType for protobuf message fedemail.MessagesAttachmentsGetRequest
 */
...
class ThreadsListRequest$Type extends MessageType<ThreadsListRequest> {
    constructor() {
        super("fedemail.ThreadsListRequest", [
            { no: 1, name: "label_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "max_results", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsListRequest
 */
...
class ThreadsGetRequest$Type extends MessageType<ThreadsGetRequest> {
    constructor() {
        super("fedemail.ThreadsGetRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsGetRequest
 */
...
class ThreadsDeleteRequest$Type extends MessageType<ThreadsDeleteRequest> {
    constructor() {
        super("fedemail.ThreadsDeleteRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsDeleteRequest
 */
...
class ThreadsModifyRequest$Type extends MessageType<ThreadsModifyRequest> {
    constructor() {
        super("fedemail.ThreadsModifyRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string id */ 1:
                    message.id = reader.string();
                    break;
                case /* fedemail.ModifyThreadRequest modify_thread_request */ 2:
    ...
    internalBinaryWrite(message: ThreadsModifyRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* fedemail.ModifyThreadRequest modify_thread_request = 2; */
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsModifyRequest
 */
...
class ThreadsTrashRequest$Type extends MessageType<ThreadsTrashRequest> {
    constructor() {
        super("fedemail.ThreadsTrashRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsTrashRequest
 */
...
class ThreadsUntrashRequest$Type extends MessageType<ThreadsUntrashRequest> {
    constructor() {
        super("fedemail.ThreadsUntrashRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message fedemail.ThreadsUntrashRequest
 */
export const ThreadsUntrashRequest = new ThreadsUntrashRequest$Type();
/**
 * @generated ServiceType for protobuf service fedemail.Fedemail
 */
export const Fedemail = new ServiceType("fedemail.Fedemail", [
