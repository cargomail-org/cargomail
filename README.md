...
Cargomail, an implementation of the [revised Internet Mail architecture](https://github.com/cargomail-org/cargomail#revised-internet-mail-architecture), introduces push and pull request layers to separate a mailbox (storage locator) from an email address (user identifier). The primary benefits of using this architecture include:
